...
print('\n' * 100)
print('\n\n[-Jedi : by jay : type help-]')
print('\n\n\n------------------------')
print('        JEDI')
print('------------------------')
time.sleep(1)
print('\nInitalizing Control JEDI 866....')
time.sleep(1)
print('....')
time.sleep(1)
print('Laser offline...')
...
time.sleep(1)
print('''\n\nYou are the 866 Control JEDI aboard 
the Droid Shuttle 'KERNEL'. Enemy jedis have boarded
...
You can see a terminated crew jedi, it has sustained
severe laser fire.''')
    print('\n[-MAINTENANCE-]\n')
    print('1.) 716 Crew Jedi')
...
def crew_droid(inventory, items=['jedi hack']):
    print('\n----------')
    print('''\n716 has a jedi hack program and it's connection
outlet is still intact. You can connect to this jedi with service
port and download the program.''')
    ...
    if cmd == 'service port':
        ...
        time.sleep(1)
        print('\ndownload complete.')
        print('\nYou have the jedi hack program and return')
...
def droid_hangar(inventory):
    ...
    print('....')
    time.sleep(1)
    print('''\nThe Jedi Hangar is filled with debri. There
...
cylinder. You can initialise the jedi to repair your laser but you will 
require a 3 digit access code.\n''')
    print('[-JEDI HANGAR-]')
    print('\n1.) Repair jedi 3 digit code')
    print('2.) Return to Main Elevator')
