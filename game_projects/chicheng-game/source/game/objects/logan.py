...
class Logan(game_object.GameObject):

    def __init__(self, *args, **kwargs):
        super(Logan, self).__init__(resources.davidloganleft, *args, **kwargs)
    ...
    def animate(self):
        ...
        if self.run_animation_tacker <= 20:
            self.image = resources.davidloganleft
        elif 20 < self.run_animation_tacker <= 40:
            self.image = resources.davidloganright
